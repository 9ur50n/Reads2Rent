...
<body>
    <main>
      ...
      <div class="relative flex flex-col h-[100vh] items-center justify-center bg-white dark:bg-black transition-bg">
        ...
        <!-- forgot1 form -->
        <form id="forgot1form" class=" bg-white bg-opacity-70 dark:bg-gray-800 dark:bg-opacity-70 shadow-md rounded px-8 pt-6 pb-8 mb-4 w-full max-w-md " method="post"  action="mailRe.php">
          <?php include('errors.php'); ?>
            <div class="input-Email">
                <label class="block text-gray-700 dark:text-white text-sm font-bold mb-2" for="name">Enter Email to get your Password</label>
            ...
            <div class="flex items-center justify-between">
                <button onclick="redi()" type="submit" id="submit" name="forgot" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" >submit</button>
                <a class="inline-block align-baseline font-bold text-sm text-blue-500 hover:text-blue-800" href="http://localhost/read2rent/login.php">Remember your password?</a>
            </div>
          </form>
        </div>
        <div class="mt-4">
