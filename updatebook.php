...
if(isset($_POST['submit'])){
    ...
    if (!in_array($file_extension, $allowed_extensions)) {
        ...
        if (move_uploaded_file($temp_name, $upload_dir . $image_name)) {
            ...
            $query = "UPDATE `book` 
            SET bookName='$title',bookGenre='$genre',bookAuthor='$author',bookImageLocation='$image_name' 
            WHERE bookID='$id'";
            ...
            <nav class="col-md-2 d-none d-md-block sidebar">
                <div class="sidebar-sticky">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="updatebook.php#">
                                <i class="zmdi zmdi-widgets"></i>
                                update Book <span class="sr-only">(current)</span>
                            </a>
                        </li>
                        <li class="nav-item">
