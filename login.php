  ...
  <main>
    <div class="relative flex flex-col h-[100vh] items-center justify-center bg-white dark:bg-black transition-bg">
      ...
      <div class="relative flex flex-col items-center">
        ...
        <!-- Login form -->
        <form id="loginForm" class="bg-white bg-opacity-70 dark:bg-gray-800 dark:bg-opacity-70 shadow-md rounded px-8 pt-6 pb-8 mb-4 w-full max-w-md" method="post" action="login.php">
        <?php include('errors.php'); ?>
          ...
          <div class="flex items-center justify-between">
            ...
            <a class="inline-block align-baseline font-bold text-sm text-blue-500 hover:text-blue-800" href="http://localhost/read2rent/mailRe.php">Forgot Password?</a>
